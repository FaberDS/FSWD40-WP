  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title"><a href="<?php echo get_bloginfo('wpurl');?>"><?= get_bloginfo('name');?></a></h1>
        <p class="lead blog-description"><?= get_bloginfo('description');?></p>
      </div>
      <div class="running-news">
          <marquee ><em>Breaking News</em>| Trump for President for the next century</marquee>
